		...
		<div class="container marketing">
			...
			<div class="row featurette">
				...
				<div style="padding-left: 20px;">
					<h3>name 속성에 값이 중복되는 HTML Form Contrl 값 받기</h3>
					<div>
						<%
						// input type="text"는 값이 입력되지 않으면 queryString으로 ""가 생성되고
						String[] textArr = request.getParameterValues("text");
						// input type="checkbox"는 값이 선택되지 않으면 null, 아무것도 반환하지 않는다. 
