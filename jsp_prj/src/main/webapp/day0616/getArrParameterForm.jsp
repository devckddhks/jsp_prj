...
<script type="text/javascript">
	...
	function addText() {
		cnt++;
		$("#txt").append(`<br><input type="text" name="text" value="네임 텍스트${cnt}">`);
	}
</script>
</head>
<body>
			...
			<div class="row featurette">
				<div class="col-md-7">
					<div style="padding-left: 20px;">
						<form action="getArrParameterFormProcess.jsp" method="get" name="frm" onsubmit="return false">
							<table>
								<tr>
									<th colspan="2">
										<h3>name 속성의 값이 중복되는 HTML Form Control</h3>
									</th>
								</tr>
								<tr>
									<td>text</td>
