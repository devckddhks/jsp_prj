...
<c:import url="http://localhost/jsp_prj/include/external_file.jsp" />
<style>
.bd-placeholder-img {
	font-size: 1.125rem;
	text-anchor: middle;
...
<body>
	...
	<header data-bs-theme="dark">
		<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
			<c:import url="http://localhost/jsp_prj/fragments/nav_bar.jsp" />
		</nav>
	</header>
	<main>
  ...
  ================================================== -->
		...
		<c:catch var="cnfe">
			<%
			//_jspService method 안에 try~catch(Throwable t)에 감싸져 있기 때문에 error가 발생하지 않는다.
