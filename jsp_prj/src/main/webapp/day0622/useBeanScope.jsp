  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div>
				...
				<!-- 3.getter method 호출 -->
				당신은 이 페이지에 <strong><jsp:getProperty property="cnt" name="cDTO"/></strong>번째 방문자 입니다.<br>
				
				<%
				String imgSrc = "";
				
				String temp = String.valueOf(cDTO.getCnt());
				
				for(int i = 0; i < temp.length(); i++) {
					imgSrc = "images/num_" + temp.charAt(i) + ".png";
				%>
					<img src="<%= imgSrc %>">
				<%
				}
