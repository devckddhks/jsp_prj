  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<!-- START THE FEATURETTES -->
			 ...
			 <%--
			 <%
			 // UserDTO를 생성하여 이름에 홍길동 이메일 "hong@test.com" 나이에 20을 저장하고 싶다.
			 // 웹 브라우저에 출력.
			 // 1. 생성
			 ...
			 <div>
			 	...
			 	이름 : <span><%= uDTO.getAge() %></span><br>
			 </div>
			  --%>
			 
			 <div>
			 	<!-- 1. 객체 생성 : 기본 생성자를 사용한 객체화 -->
			 	<jsp:useBean id="ud" class="day0622.UserDTO" scope="page"></jsp:useBean>
			 	...
			 	id가 객체명이므로 scriptlet에서 해당 객체를 사용할 수 있다.
			 	<%
