...
<body>
  ...
  ================================================== -->
		...
		<div class="container marketing">
			<h2>이동한 디자인 페이지</h2>
			<%
			request.setCharacterEncoding("UTF-8"); // web parameter의 한글이 깨지는 것을 막기 위해서
			// 요청 객체에 charset을 encoding 한다.
			
			// request객체에 속성으로 추가된 값
			String name = (String) request.getAttribute("name");
			String[] job = (String[]) request.getAttribute("jobArr");
