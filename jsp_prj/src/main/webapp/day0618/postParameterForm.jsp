...
<link href="http://localhost/jsp_prj/common/js/bootstrap.min.css" rel="stylesheet" integrity="sha384-sRIl4kxILFvY47J16cr9ZwB07vP4J8+LH7qKQnuqkuIAvNWLzeN8tE5YBujZqJLB">
...
<body>
  ...
  ================================================== -->
			...
			<div class="row featurette">
				<div class="col-md-7">
					<div style="padding-left: 20px;">
						<form action="postParameterFormProcess.jsp" method="post" name="frm" en onsubmit="return false">
							<table>
								<tr>
									<th colspan="2">
										<h3>name 속성의 값이 유일한 HTML Form Control(POST방식의 요청)</h3>
									</th>
								</tr>
								<tr>
									<td>text</td>
									<td>
										<input type="text" name="text" value="네임 텍스트">
									</td>
								</tr>
								<tr>
									<td>password</td>
									<td>
										<input type="password" name="pass" value="어짜피안보여">
									</td>
								</tr>
								<tr>
									<td>radio</td>
								...
								<tr>
									<td>check</td>
									<td>
										<input type="checkbox" name="agree" value="Y" checked="checked">수신 동의
									</td>
								</tr>
								<tr>
									<td>select</td>
								...
								<tr>
									<td colspan="2">
										<button class="btn btn-outline-primary btn-sm" id="btn">입력</button>
									</td>
								</tr>
							</table>
						</form>
		...
		<footer class="container">
			...
			<p>
				&copy; 2017–2025 Company, Inc. &middot; <a href="#">Privacy</a> &middot; <a href="#">Terms</a>
			</p>
		</footer>
	</main>
	<script src="http://localhost/jsp_prj/common/js/bootstrap.bundle.min.js" integrity="sha384-FKyoEForCGlyvwx9Hj09JcYn3nv7wiPVlz7YYwJrWVcXK/BmnVDxM+D2scQbITxI" class="astro-vvvwv3sm"></script>
</body>
</html>