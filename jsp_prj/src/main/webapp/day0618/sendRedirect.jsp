...
<%
// 특정 ip로 요청되면 다른 site로 이동
String ip = request.getRemoteAddr();

String[] blockedIp = {"192.168.10.70", "192.168.10.87", "192.168.10.74", "192.168.10.79"};
...
<script src="http://192.168.10.80/jsp_prj/common/js/color-modes.js"></script>
<link href="http://192.168.10.80/jsp_prj/common/js/bootstrap.min.css" rel="stylesheet" integrity="sha384-sRIl4kxILFvY47J16cr9ZwB07vP4J8+LH7qKQnuqkuIAvNWLzeN8tE5YBujZqJLB">
<meta name="theme-color" content="#712cf9">
<link href="http://192.168.10.80/jsp_prj/common/js/carousel.css" rel="stylesheet">
<style>
.bd-placeholder-img {
	font-size: 1.125rem;
	text-anchor: middle;
...
<body>
  ...
  ================================================== -->
			...
			<div class="row featurette">
				<div class="col-md-7">
					<h2 class="featurette-heading fw-normal lh-1">
						...
						%>
						<span class="text-body-secondary"><span class="<%= color %>"><%= request.getMethod() %></span></span>
					</h2>
	...
	<script src="http://192.168.10.80/jsp_prj/common/js/bootstrap.bundle.min.js" integrity="sha384-FKyoEForCGlyvwx9Hj09JcYn3nv7wiPVlz7YYwJrWVcXK/BmnVDxM+D2scQbITxI" class="astro-vvvwv3sm"></script>
	<%
	log("asfasfasfafsdaf");
	%>
</body>
